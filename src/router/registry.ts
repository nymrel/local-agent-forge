...
export const LOCAL_MODELS_REGISTRY: Record<string, ModelCapability> = {
  'qwen2.5-coder:7b': {
...
export function getBestLocalModelForTask(category: string, availableModels: string[]): string {
  if (availableModels.length === 0) return 'qwen2.5-coder:7b';
